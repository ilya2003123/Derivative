...
class Derivative<operations::Subtract<F1, F2>>
{
public:
...
class Derivative<operations::Subtract<F1, functions::Const>>
{
public:
...
class Derivative<operations::Subtract<functions::Const, F2>>
{
public:
...
template<>
class Derivative<operations::Subtract<functions::Const, functions::Const>>
{
public:
...
template <>
class Derivative<operations::Subtract<functions::Simple, functions::Simple>>
{
public:
